...
//            DbOpretions.setOrDeleteData(categoryTbl, "Category Table is created");
//            /////////product Table 
...
//            DbOpretions.setOrDeleteData(productTbl, "Product Table is Created.");
            ////creat Bill table
            String billTable = "create table bill(id int PRIMARY KEY, name varchar(150),mobileNumber varchar(50),email varchar(150),date varchar(50), total varchar(20),createBy varchar(200))";
            DbOpretions.setOrDeleteData(billTable, "Bill Table created.");
